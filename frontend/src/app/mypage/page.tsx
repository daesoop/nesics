              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="border-b border-gray-200">
                    <td className="py-4 px-4 bg-gray-50 font-semibold text-gray-700 w-32">
                      공사업체코드(ID)
                    </td>
                    ...
                    <td className="py-4 px-4">
                      <input
                        ...
                        onChange={(e) =>
                          handleUserInfoChange("manager", e.target.value)
                        }
                  ...
                  <tr>
                    ...
                    <td className="py-4 px-4">
                      <input
                        ...
                        onChange={(e) =>
                          handleUserInfoChange("companyName", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="회사명"
                      />
                    ...
                    <td className="py-4 px-4">
                      <input
                        ...
                        onChange={(e) =>
                          handleUserInfoChange("businessSite", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="사업장 주소"
                      />
